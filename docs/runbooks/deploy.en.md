# Runbook — sdkwork-news deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-news-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-news/bundle`, loads the image, starts
